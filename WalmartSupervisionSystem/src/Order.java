...
public class Order extends javax.swing.JFrame {
    ...
    public Order() {
        ...
        ResultSet rs = DB.executeQuery("select * from orders");
        
//        for (int i=0; i<12; i++){
//            ResultSet rs1 = DB.executeQuery("INSERT INTO users (id, name, phone) values ((SELECT id+2 FROM employee WHERE id = 1), (SELECT ename FROM employee WHERE id = 1), (SELECT phone FROM employee WHERE id = 1 ));");
//
//        }
        ...
        model.addColumn("Product 1");
        model.addColumn("Product 2");
        model.addColumn("Product 3");
        model.addColumn("Quantity 1");
        model.addColumn("Quantity 2");
        model.addColumn("Quantity 3");

        try{
            while(rs.next()){

                System.out.println(rs.getInt(1) );
                model.addRow(new Object[]{rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(5), rs.getInt(6), rs.getInt(7), rs.getInt(8), rs.getInt(9), rs.getInt(10)});
    ...
    private void orderBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderBActionPerformed
        JOptionPane.showMessageDialog(null, "Order Table is already opened, please observe.");
