...
public class Revenues extends javax.swing.JFrame {
    ...
    public Revenues() {
        ...
        ResultSet rs = DB.executeQuery("select * from revenues");

        DefaultTableModel model1 = (DefaultTableModel)jTable1.getModel();
        model1.addColumn("ID");
        model1.addColumn("Value"); // revenues are monthly
        model1.addColumn("Transaction Date");
        ...
        try{
            while(rs.next()){
                ...
                model1.addRow(new Object[]{rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getString(4)});
    ...
    private void revenuesBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_revenuesBActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null, "Revenues table is already opened, please observe.");
