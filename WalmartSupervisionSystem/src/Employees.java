...
public class Employees extends javax.swing.JFrame{
    ...
    public Employees() {
        ...
        model2.addColumn("Job_Id");
        model2.addColumn("Salary");
        model2.addColumn("Date Joined");
        model2.addColumn("Supervisor_id");
        model2.addColumn("Management_id");

        try{
            while(rs.next()){

                System.out.println(rs.getInt(1) );
                model2.addRow(new Object[]{rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(5), rs.getString(6), rs.getInt(7), rs.getInt(8) });
    ...
    private void employeeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_employeeBActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null, "Employees Table is already opened, please observe.");
