...
public class Local extends Trains {
//    private int ESeats;
//    private int EFair;
     ...
     */
    public Local(int trainId, String trainName, int BSeats, int BFair, int ESeats, int EFair, String Destination) {
    ...
    public String toString() {
        return super.toString() + getBSeats() + " " + getBFair() + " " + getESeats() + " " + getEFair() + " " + this.Destination;
    }

    /**
     * Takes id in its parameter passes business file object to equals method of
     * Trains class
     */
    ...
    public boolean updateTrain(int id, int edit) {
        ...
        if (edit == 1) {
            ...
            int Bseats = Integer.parseInt(JOptionPane.showInputDialog("Enter Number of Business seats: "));
            ...
            try {
                ...
                while (s.hasNext()) {
                    ...
                    if (Integer.parseInt(s2[0]) == id) {
                        s2[2] = String.valueOf(Bseats);
                    }
                    Local e = new Local(Integer.parseInt(s2[0]), s2[1], Integer.parseInt(s2[2]), Integer.parseInt(s2[3]), Integer.parseInt(s2[4]), Integer.parseInt(s2[5]), s2[6]);
            ...
            int Bfair = Integer.parseInt(JOptionPane.showInputDialog("Enter Fair for one Business seat: "));
            ...
            int Eseats = Integer.parseInt(JOptionPane.showInputDialog("Enter Number of Enonomy seats: "));
            ...
            int Efair = Integer.parseInt(JOptionPane.showInputDialog("Enter Fair for one Economy seat: "));
    ...
    public Object searchTrain_id(int id) {
        ...
        try {
            ...
            while (s.hasNext()) {
                ...
                String[] s2 = s1.split(" ");
                if (Integer.parseInt(s2[0]) == id) {
                    c = new Local(Integer.parseInt(s2[0]), s2[1], Integer.parseInt(s2[2]), Integer.parseInt(s2[3]), Integer.parseInt(s2[4]), Integer.parseInt(s2[5]), s2[6]);
                    s.close();
                    break;
                }
            }
