...
public class permResident_GUI extends JFrame implements ActionListener
{
    public permResident_GUI()
    {
        setVisible(true);
        setSize(1100, 700);
        setResizable(false);
    ...
    JLabel tempResidentGUIheading = new JLabel("Permanent Residents Menu", JLabel.CENTER);
    ...
    public void actionPerformed(ActionEvent e)
    {
        switch(e.getActionCommand())
        {
            ...
            case "ADD RECORD":
                new permResidentADD_GUI();
                break;
                
            case "VIEW RECORDS":
                new permResidentVIEW_GUI();
                break;
                
            case "SEARCH RECORD":
                new permResidentSEARCH_GUI();
                break;
                
            case "UPDATE RECORD":
                new permResidentUPDATE_GUI();
                break;
                
            case "DELETE RECORD":
                new permResidentDELETE_GUI();
                break;
        }
    }
}
