...
public class permResidentUPDATE_GUI extends JFrame implements ActionListener
{
    public permResidentUPDATE_GUI()
    {
        setVisible(true);
        setSize(900, 500);
        setResizable(false);
        ...
        switch(e.getActionCommand())
        {
            case "UPDATE":
                try
                {
                    ...
                    r = new permResident(ID, name, gender, phoneNo, email, roomNo);
                    r.updateRecord();
                }
                catch(Exception ex)
                {
