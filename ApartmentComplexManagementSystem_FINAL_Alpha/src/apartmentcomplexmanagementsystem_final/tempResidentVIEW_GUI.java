...
public class tempResidentVIEW_GUI extends JFrame //ACTION LISTENR IN ANOTHER CLASS
{
    public tempResidentVIEW_GUI()
    {
        setVisible(true);
        setSize(900, 500);
        setResizable(false);
    ...
    ArrayList<String> a = tempResident.viewRecords();
}
