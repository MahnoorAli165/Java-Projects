...
public class tempResidentDELETE_GUI extends JFrame 
{
    public tempResidentDELETE_GUI()
    {
        setVisible(true);
        setSize(400, 150);
        setResizable(false);
        ...
        action.addActionListener(listen);
    ...
    public class MyActionListener implements ActionListener //Inner class
    {
            ...
            switch(e.getActionCommand())
            {
                case "DELETE":
                    ...
                    try
                    {
                        ...
                        r = new tempResident(ID, null, null, 0, null, 0);
                        r.deleteRecord();
                    }
                    catch(Exception ex)
                    {
