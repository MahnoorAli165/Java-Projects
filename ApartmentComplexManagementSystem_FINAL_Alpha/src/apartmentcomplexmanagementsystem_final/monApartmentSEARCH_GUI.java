...
public class monApartmentSEARCH_GUI extends JFrame implements ActionListener
{
    public monApartmentSEARCH_GUI()
    {
        setVisible(true);
        setSize(400, 150);
        setResizable(false);
    ...
    JLabel IDTFlabel = new JLabel("Enter Apartment Number:");
