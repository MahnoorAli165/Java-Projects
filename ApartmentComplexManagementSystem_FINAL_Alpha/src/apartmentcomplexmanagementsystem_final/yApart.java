...
public class yApart extends Apartment
{
    int monthlyRent;
    ...
    public yApart(int apartNo, int floor, int size, int monthlyRent)
    {
    ...
    public boolean addRecord() 
    {
        ...
        if((searchapartNo() == null))
        {
            ...
            try
            {
                f = new FileWriter("yApart.txt", true);
                f.write(toString() + "\n");
                f.close();
                result = true;
    ...
    public boolean updateRecord()
    {
        try
        {
            ...
            File f1 = new File("yApart_temp.txt");
    ...
    public yApart searchapartNo()
    {
        ...
        try
        {
            ...
            while(input.hasNext())
            {
                ...
                {
                    r = new yApart(Integer.parseInt(s[0]), Integer.parseInt(s[1]), Integer.parseInt(s[2]), Integer.parseInt(s[3]));
                    break;
                }
                else
                {
