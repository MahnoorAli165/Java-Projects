...
public class tempResident_GUI extends JFrame implements ActionListener
{
    public tempResident_GUI()
    {
        setVisible(true);
        setSize(1100, 700);
        setResizable(false);
    ...
    JLabel tempResidentGUIheading = new JLabel("Temporary Residents Menu", JLabel.CENTER);
 ...
 public void actionPerformed(ActionEvent e) 
    {
        switch(e.getActionCommand())
        {
            ...
            case "ADD RECORD":
                new tempResidentADD_GUI();
                break;
                
            case "VIEW RECORDS":
                new tempResidentVIEW_GUI();
                break;
                
            case "SEARCH RECORD":
                new tempResidentSEARCH_GUI();
                break;
                
            case "UPDATE RECORD":
                new tempResidentUPDATE_GUI();
                break;
                
            case "DELETE RECORD":
                new tempResidentDELETE_GUI();
                break;
           case "BACK":
                setVisible(false);
                break;
