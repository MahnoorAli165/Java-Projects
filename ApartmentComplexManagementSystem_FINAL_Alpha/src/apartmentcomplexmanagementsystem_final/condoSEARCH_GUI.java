...
public class condoSEARCH_GUI extends JFrame implements ActionListener
{
    public condoSEARCH_GUI()
    {
        setVisible(true);
        setSize(400, 150);
        setResizable(false);
    ...
    JLabel IDTFlabel = new JLabel("Enter Condo Number:");
