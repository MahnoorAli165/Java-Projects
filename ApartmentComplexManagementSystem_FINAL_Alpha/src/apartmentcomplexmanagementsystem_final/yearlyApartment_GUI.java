...
public class yearlyApartment_GUI extends JFrame implements ActionListener
{
    public yearlyApartment_GUI()
    {
        setVisible(true);
        setSize(1100, 700);
        setResizable(false);
    ...
    JLabel tempResidentGUIheading = new JLabel("Yearly Apartments Menu", JLabel.CENTER);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        switch(e.getActionCommand())
        {
            ...
            case "ADD RECORD":
                new yApartmentADD_GUI();
                break;
                
            case "VIEW RECORDS":
                new yApartmentVIEW_GUI();
                break;
                
            case "SEARCH RECORD":
                new yApartmentSEARCH_GUI();
                break;
                
            case "UPDATE RECORD":
                new yApartmentUPDATE_GUI();
                break;
                
            case "DELETE RECORD":
                new yApartmentDELETE_GUI();
                break;
        }
    }
}
