...
public class monthlyApartment_GUI extends JFrame implements ActionListener
{
    public monthlyApartment_GUI()
    {
        setVisible(true);
        setSize(1100, 700);
        setResizable(false);
    ...
    JLabel tempResidentGUIheading = new JLabel("Monthly Apartments Menu", JLabel.CENTER);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        switch(e.getActionCommand())
        {
            ...
            case "ADD RECORD":
                new monApartmentADD_GUI();
                break;
                
            case "VIEW RECORDS":
                new monApartmentVIEW_GUI();
                break;
                
            case "SEARCH RECORD":
                new monApartmentSEARCH_GUI();
                break;
                
            case "UPDATE RECORD":
                new monApartmentUPDATE_GUI();
                break;
                
            case "DELETE RECORD":
                new monApartmentDELETE_GUI();
                break;
        }
    }
}
