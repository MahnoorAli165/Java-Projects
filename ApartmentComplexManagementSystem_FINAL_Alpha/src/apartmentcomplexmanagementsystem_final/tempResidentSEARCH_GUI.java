...
public class tempResidentSEARCH_GUI extends JFrame implements ActionListener
{
    public tempResidentSEARCH_GUI()
    {
        setVisible(true);
        setSize(400, 200);
        setResizable(false);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        switch(e.getActionCommand())
        {
            ...
            case "SEARCH BY NAME":
                String name;
                tempResident r1 = null;
                try
                {
                    name = NAMETF.getText();
                    r1 = new tempResident(0, name, null, 0, null, 0);
                    r1.searchRecordName();
                }
                catch(Exception ex)
                {
